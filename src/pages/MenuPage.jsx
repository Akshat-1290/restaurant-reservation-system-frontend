...
export default function MenuPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://restaurant-reservation-system-backend-qq29.onrender.com/api/checkout/create-checkout-session",
        {
          method: "POST",
          headers: {
  ...
  useEffect(() => {
    const fetchMenuItems = async () => {
      ...
      try {
        const response = await fetch(
          "https://restaurant-reservation-system-backend-qq29.onrender.com/api/menu/getAll"
        );
