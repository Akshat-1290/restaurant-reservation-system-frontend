...
const AdminMenuPage = () => {
  ...
  const fetchMenuItems = async () => {
    try {
      const response = await fetch('https://restaurant-reservation-system-backend-qq29.onrender.com/api/menu/getAll');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://restaurant-reservation-system-backend-qq29.onrender.com/api/menu/delete/${id}`, {
        method: 'DELETE',
        headers: {
          'x-auth-token': token
        },
  ...
  const handleCreate = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://restaurant-reservation-system-backend-qq29.onrender.com/api/menu/create', {
        method: 'POST',
        headers: {
  ...
  const handleEdit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://restaurant-reservation-system-backend-qq29.onrender.com/api/menu/update/${editItem._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'x-auth-token': token
